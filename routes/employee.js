...
router.get("/presentEmployee", employeeController.getPresentEmployees);
router.get("/actives", employeeController.getEmployeesActives);
router.post("/", employeeController.createEmployee);
router.put("/:employeeID", employeeController.updateEmployee);
router.put(
  "/updateEvaluationStep/:employeeID",
  employeeController.updateEvaluation
);
...
router.post("/disabledEmployee", employeeController.disabledEmployee);
...
router.put(
  "/updateFamilyInfo/:familyInfoID",
  employeeController.updateFamilyInfo
);
router.delete(
  "/deleteFamilyInfo/:familyInfoID",
...
router.put(
  "/updateAuxRelative/:auxRelativeID",
  employeeController.updateAuxRelative
);
router.delete(
  "/deleteAuxRelative/:auxRelativeID",
  employeeController.deleteAuxRelative
);
router.delete(
  "/deleteAuxRelativeByEmployee/:employeeID",
  employeeController.deleteAuxRelativeByEmployee
);
////// Rutas para informacion de benefiarios //////
router.post(
  "/addBeneficiaryInfo/:employeeID",
  employeeController.addBeneficiaryInfo
);
router.put(
  "/updateBeneficiaryInfo/:beneficiaryID",
  employeeController.updateBeneficiaryInfo
);
router.delete(
  "/deleteBeneficiaryInfo/:beneficiaryID",
  employeeController.deleteBeneficiaryInfo
);
