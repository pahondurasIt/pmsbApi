    ...
    switch (opButton) {
      case 'city':
        const resultCity = await db.query(`INSERT INTO cities_emp 
          (cityName, stateID, createdDate, createdBy) VALUES (?, ?, ?)`, [newValue, stateID, camposAuditoriaADD(req)]);
      ...
      case 'sector':
        const resultSector = await db.query(`INSERT INTO sectors_emp 
          (sectorName, cityID, createdDate, createdBy) VALUES (?, ?, ?)`, [newValue, cityID, camposAuditoriaADD(req)]);
      ...
      case 'suburb':
        const resultSuburb = await db.query(`INSERT INTO suburbs_emp 
          (suburbName, sectorID, createdDate, createdBy) VALUES (?, ?, ?)`, [newValue, sectorID, camposAuditoriaADD(req)]);
